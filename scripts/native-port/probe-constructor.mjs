...
try {
  ...
  if(kirbyCopy&&renderSteps&&!probe.error&&[3,15,16,22].includes(probe.kirbyCopy.copyKind)&&!(probe.kirbyCopy.bodyRenderedFrames>0&&probe.kirbyCopy.peakBodyDraws>0))throw Error('Copied body was not drawn');
