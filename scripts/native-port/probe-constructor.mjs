...
if(kirbyCopy&&(character!=='Kb'||!['Mr','Lg','Dr','Ca','Gn','Ns','Pe','Fx','Pk','Pc','Lk','Cl','Ss','Fc','Dk','Ms','Fe','Zd','Sk','Kp'].includes(opponent)||!process.argv.includes('--input')||!['swallow','acquire','spit','contact','reflect','reflect-control'].includes(kirbyCopy)||kirbyCopy.startsWith('reflect')&&opponent!=='Zd'))throw Error('Kirby copy requires Kb versus Mr/Lg/Dr/Ca/Gn/Ns/Pe/Fx/Pk/Pc/Lk/Cl/Ss/Fc/Dk/Ms/Fe/Zd/Sk/Kp and input');
