...
if(kirbyCopy&&(character!=='Kb'||!['Mr','Lg','Dr','Ca','Gn','Ns','Pe','Fx','Pk','Pc','Lk','Cl','Ss'].includes(opponent)||!process.argv.includes('--input')||!['swallow','acquire','spit','contact'].includes(kirbyCopy)))throw Error('Kirby copy requires Kb versus Mr/Lg/Dr/Ca/Gn/Ns/Pe/Fx/Pk/Pc/Lk/Cl/Ss and input');
