...
try {
  ...
  if(scene) {
    ...
    if(!verification.shared?.passed||verification.shared.fields!==536||verification.shared.parts!==34||verification.shared.sections.length!==17)throw Error('Incomplete typed shared-data coverage');
