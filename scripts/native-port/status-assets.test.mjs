...
function hudFixture(change=()=>{}) {
  ...
  ptr(520,40);ptr(528,40);change({d,ptr,relocs});
  const roots=[['ScInfCnt_scene_models',0],['ScInfDmg_scene_data',160],['ScInfTim_scene_models',520],['tdsce',528]],text=new TextEncoder().encode(roots.map(([s])=>s+'\0').join('')),pub=32+body.length+relocs.size*4;
