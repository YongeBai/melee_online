...
try {
  ...
  for(const name of [...shared,...names,...fighters,...animations,...models]) {
  ...
  console.log('Prepared shared fighter data, six stages and 27 playable fighter components in ignored dist/native-port.');
