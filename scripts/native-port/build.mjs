...
if(resultScene)exports.push('portResultScenePlayerSnapshot','portResultSceneWinnerSnapshot','portResultSceneConfigureStats','portResultSceneTextOwners','portResultFightersInitialize','portResultFighter','portResultFighterSnapshot','portItemsInitialize');
