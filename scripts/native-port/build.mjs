...
if(scene)selectedUnits.push('src/melee/ft/ftmetal.c','src/melee/ft/ftanim.c','src/melee/ft/ftmaterial.c','src/melee/lb/lbrefract.c','src/melee/ft/ftdevice.c','src/melee/ft/kinds/ftCommon/ftCo_09F4.c','src/melee/ft/ft_0C8C.c','src/melee/ft/ftCo_800C7CA0.c','src/melee/ft/ftcoll.c','src/melee/lb/lbcollision.c','src/melee/lb/lb_00B0.c','src/melee/lb/lbanim.c','src/melee/lb/lbarchive.c','src/melee/lb/lb_013B.c','src/melee/lb/lb_0219.c','src/melee/ft/ftaction.c','src/melee/ft/ftcmdscript.c','src/melee/ft/ftcpuattack.c','src/melee/ft/ftdata.c','src/melee/ft/ftparts.c','src/melee/ft/ftcommon.c','src/melee/ft/fighter.c','src/melee/pl/player.c');
