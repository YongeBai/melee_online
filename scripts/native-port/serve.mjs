...
const files=new Set(['resident-files.mjs','verify-resident-files.mjs','index.html','melee-native.mjs','melee-native.wasm','melee-scene.mjs','melee-scene.wasm','scene-build.json','archive.mjs','scene-assets.mjs','verify-scene.mjs','scene.html',
