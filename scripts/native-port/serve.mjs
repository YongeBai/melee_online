...
files.add('native-rollback-driver.mjs');files.add('native-product-rollback.mjs');files.add('result-fixtures.json');files.add('result-motion-assets.mjs');files.add('native-result-scene-preview.mjs');files.add('native-result-live.mjs');files.add('result-efb.mjs');files.add('result-scene.html');files.add('melee-result-scene.mjs');files.add('melee-result-scene.wasm');
