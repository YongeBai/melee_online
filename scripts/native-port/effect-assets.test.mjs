...
test('fighter effect banks preserve bank identity, model count and model-only null banks',()=>{
  ...
  assert.throws(()=>convertFighterEffects(new Uint8Array(),'Kb'),/pending/);
});
