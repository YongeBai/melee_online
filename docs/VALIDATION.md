...
46,800 distinct 960×720 post-draw snapshots with no capture/content errors.
Observed cadence was 59.700–59.970 FPS, simulation was 59.557–59.933 FPS, and
draw p95 was 7.1–14.1 ms. The separate 12-case stage/seat matrix observed both
seats on all six legal stages. These results still exclude WAN, compositor
scanout, physical input-to-photon and exhaustive matchup timing; see the
[roster performance matrix](benchmarks/browser-2026-09-18-native-room-roster-720p60.json),
