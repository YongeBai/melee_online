...
For the separate browser-only package that needs no GPU server, see
[BROWSER-DEPLOYMENT.md](BROWSER-DEPLOYMENT.md). The instructions below are for
the native streaming service.
