...
export function createPresentationCache({submissionOptimized=true,packedState=true,reuseImmediate=true,exactState=true,compactShaderKey=true,uniformBuffer=true,profileDraw=false}={}){
  ...
  return {
    ...
    acquire(gl){
      ...
      return {
        ...
        tevInterner,shaderKey,programs,variants,submissionOptimized,packedState,reuseImmediate,exactState,compactShaderKey,profileDraw,
        immediate,
