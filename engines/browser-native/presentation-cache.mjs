...
export function createPresentationCache({submissionOptimized=true,packedState=true,reuseImmediate=true,cacheImmediateViews=true,cacheTextureView=true,exactState=true,compactShaderKey=true,compactTextureKey=true,uniformBuffer=true,profileDraw=false}={}){
  ...
  return {
    ...
    acquire(gl){
      ...
      return {
        ...
        tevInterner,shaderKey,programs,variants,submissionOptimized,packedState,reuseImmediate,cacheImmediateViews,cacheTextureView,exactState,compactShaderKey,compactTextureKey,profileDraw,
        immediate,
