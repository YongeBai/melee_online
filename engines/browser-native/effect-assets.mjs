...
export function convertKirbyCopyEffects(input,code){
  const profile={Dk:['Donkey',39,0,0,2],Fc:['Fox',33,0,0,1],Ss:['Samus',34,11,7,1],Pk:['Pikachu',36,4,2,0],Pc:['Pikachu',36,4,2,0],Fx:['Fox',33,0,0,1],Mr:['Mario',32,7,3,1],Dr:['Mario',32,7,3,1],Lg:['Luigi',37,7,3,1],Ca:['Captain',38,4,3,2],Gn:['Ganon',47,4,3,2]}[code];
